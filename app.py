...
# ─── Supabase helpers ──────────────────────────────────────────────────────────
def get_config():
    url = os.environ.get('https://hgnltcwzufcvzxwqgsfy.supabase.co', '').rstrip('/')
    key = os.environ.get('eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imhnbmx0Y3d6dWZjdnp4d3Fnc2Z5Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3Nzk3NjM4MTksImV4cCI6MjA5NTMzOTgxOX0.E-ZvXk2y19vaCxZkJmuH4bJ7diA1C7OYMQgpOIZqkOI', '')
    return url, key
